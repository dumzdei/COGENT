...
bool Parser_Verilog::loadFile(const std::string& filename)
{
    lines.clear();
...
inline std::string Parser_Verilog::trim(const std::string& str)
{
...
std::string Parser_Verilog::extractTag(std::string& text)
{
...
std::vector<Port> Parser_Verilog::PortParcer(const std::string& source_line)
{
...
std::vector<Param> Parser_Verilog::ParamParcer(const std::string& source_line)
{
